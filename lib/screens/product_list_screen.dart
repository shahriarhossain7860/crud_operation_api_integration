...
import 'package:crud_operation_api_integration/screens/add_new_product_screen.dart';
import 'package:crud_operation_api_integration/widgets/product_item.dart';
...
bool _inProgress = false;
      ...
      body: _inProgress? const Center(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            return ProductItem(
                 product: productList[index], onDelete: (productId) => deleteProduct(productId),
            );
          },
 ...
 Future<void> deleteProduct(String productId) async{
   ...
   Response response = await get(uri); // Delete request using GET
